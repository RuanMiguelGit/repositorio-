...
const filterPeople =(person) => {
 ...
 const idade = element => element >= 1901 && element < 2000;
 const nation = element => element === "Australian";

 return person.filter(({bornIn, nationality}) => idade(bornIn) && nation(nationality))}
